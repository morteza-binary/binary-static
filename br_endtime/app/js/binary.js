...
/******/ 	__webpack_require__.p = "/br_endtime/app/js/";
/******/
...
var Duration = function Duration(_ref) {
    ...
    var is_within_24_hours = moment_expiry.diff((0, _moment2.default)(start_date * 1000 || undefined).utc(), 'hour') <= 24;
    var should_show_time_picker = false;
    var expiry_time_sessions = sessions;

    if (start_date === 0 && moment_expiry.isSame((0, _moment2.default)(start_date * 1000 || undefined).utc(), 'day')) {
    ...
    if (expiry_type === 'endtime') {
        if (is_within_24_hours) {
            ...
            var _start_time$split3 = start_time.split(':'),
                _start_time$split4 = _slicedToArray(_start_time$split3, 2),
                start_hour = _start_time$split4[0],
                start_minute = _start_time$split4[1];

            var moment_contract_start_date_time = _moment2.default.utc(start_date * 1000 || undefined).hour(start_hour).minute(start_minute);
    ...
    return _react2.default.createElement(
        ...
        expiry_type === 'duration' ? _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                should_show_time_picker && _react2.default.createElement(_time_picker2.default, {
                    onChange: onChange,
                    is_align_right: true,
                    name: 'expiry_time',
                    value: expiry_time,
...
var ContractType = function () {
    ...
    var getExpiryTime = function getExpiryTime(sessions, start_date, start_time, expiry_date, expiry_time) {
        ...
        if (sessions && !(0, _start_date.isSessionAvailable)(expiry_sessions, end_moment)) {
...
var createProposalRequestForContract = function createProposalRequestForContract(store, type_of_contract) {
    ...
    if (store.expiry_type === 'endtime') {
        ...
        var is_same_day = expiry_date.isSame(start_date, 'day') || store.start_date && expiry_date.diff(start_date, 'hour') <= 24;
